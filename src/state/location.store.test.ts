...
describe('LocationStore', () => {
  ...
  describe('initialization', () => {
    ...
    it('should initialize with provided initial state', () => {
      const initialState = {
        currentLocation: { lat: 37.7749, lng: -122.4194, name: 'San Francisco' },
        isLoading: false,
        error: null
      }
  ...
  describe('setLocation', () => {
    it('should set a valid location', () => {
      const location = { lat: 40.7128, lng: -74.0060, name: 'New York' }
    ...
    it('should validate latitude bounds', () => {
      ...
      expect(() => locationStore.setLocation(invalidLocation))
  ...
  describe('clearLocation', () => {
    it('should clear current location', () => {
      locationStore.setLocation({ lat: 40.7128, lng: -74.0060 })
  ...
  describe('calculateDistance', () => {
    ...
    it('should throw error for invalid coordinates', () => {
      const validPoint = { lat: 40.7128, lng: -74.0060 }
      const invalidPoint = { lat: 91, lng: 0 }
      
      expect(() => locationStore.calculateDistance(validPoint, invalidPoint))
    ...
    it('should throw error for null or undefined coordinates', () => {
      ...
      expect(() => locationStore.calculateDistance(validPoint, null))
        .toThrow('Invalid coordinates')
      
      expect(() => locationStore.calculateDistance(null, validPoint))
        .toThrow('Invalid coordinates')
    })
  })
  ...
  describe('isLocationValid', () => {
    ...
    it('should return false for invalid coordinates', () => {
      const invalidLocations = [
        ...
        { lat: 0 }, // missing lng
        { lng: 0 }, // missing lat
        { lat: '40.7128', lng: -74.0060 }, // string coordinates
        { lat: 40.7128, lng: '-74.0060' }
      ]
  ...
  describe('state management integration', () => {
    ...
    it('should handle rapid state changes', () => {
      ...
      expect(locationStore.currentLocation).toEqual({ lat: 99 % 90, lng: 99 % 180 })
      expect(locationStore.isLoading).toBe(false)
      expect(locationStore.error).toBeNull()
    })
  ...
  describe('edge cases and stress tests', () => {
    ...
    it('should handle memory cleanup', () => {
      ...
      for (let i = 0; i < 1000; i++) {
        locationStore.setLocation({ lat: Math.random() * 180 - 90, lng: Math.random() * 360 - 180 })
      }
