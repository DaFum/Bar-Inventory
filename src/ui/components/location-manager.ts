...
/**
 * Zeigt die Detailansicht eines Standorts mit Stammdaten, Bearbeitungsoption und zugehöriger Zählerverwaltung an.
 *
 * Die Funktion setzt den aktiven Standort, zeigt dessen Name und Adresse, ermöglicht die Bearbeitung der Stammdaten und blendet die Verwaltung der zugehörigen Zähler ein. Ein Schließen-Button beendet die Detailansicht.
 *
 ...
 * @param locationName - Der Name des zu löschenden Standorts
 */
 ...
 *
 * Zeigt bei Abbruch einer Bearbeitung die Detailansicht des aktuellen Standorts erneut an. Wird das Hinzufügen eines neuen Standorts abgebrochen, wird der Detailbereich ausgeblendet.
 */
...
/**
 * Rendert die Tresenverwaltung für den angegebenen Standort im UI.
 *
 * Zeigt die Liste der Tresen (Counter) des Standorts an und ermöglicht das Hinzufügen, Bearbeiten und Löschen von Tresen über entsprechende Komponenten und Schaltflächen.
 *
 ...
 *
 * Fordert den Benutzer zur Bestätigung auf und entfernt bei Zustimmung den angegebenen Tresen aus dem Standort. Bei Erfolg oder Fehler wird eine Benachrichtigung angezeigt. Ist das gelöschte Tresen-Formular geöffnet, wird es geschlossen.
 */
