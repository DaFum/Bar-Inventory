 ...
 *
 * Die Ansicht enthält Standortname, Adresse, einen Button zum Bearbeiten der Stammdaten, eine Übersicht der Zähler sowie einen Schließen-Button. Vorheriger Inhalt im Detailbereich wird überschrieben.
 *
...
/**
 * Löscht einen Standort sowie alle zugehörigen Tresen und Bereiche nach Benutzerbestätigung.
 *
 ...
 * @param locationName - Der Name des zu löschenden Standorts, wird in der Bestätigungs- und Rückmeldungsanzeige verwendet
 */
 ...
 *
 * @param locationData - Die Standortdaten (ID, Name, Adresse), die hinzugefügt oder aktualisiert werden sollen.
 */
 ...
 *
 * Bei Abbruch einer Bearbeitung wird die Detailansicht des aktuellen Standorts erneut angezeigt. Beim Abbruch eines neuen Standorts wird der Detailbereich ausgeblendet.
 */
...
/**
 * Zeigt die Tresenverwaltung für den angegebenen Standort an und ermöglicht das Hinzufügen, Bearbeiten und Löschen von Tresen.
 *
 * Rendert die Liste aller Tresen des Standorts sowie das Formular zur Bearbeitung oder Erstellung eines Tresens. Die Benutzeroberfläche wird entsprechend aktualisiert, um Interaktionen mit Tresen zu ermöglichen.
 *
...
/**
 * Verarbeitet das Absenden des Tresen-Formulars zum Hinzufügen oder Bearbeiten eines Tresens im aktuell ausgewählten Standort.
 *
 * Fügt einen neuen Tresen hinzu oder aktualisiert einen bestehenden Tresen im aktiven Standort. Zeigt eine Erfolgs- oder Fehlermeldung an und blendet das Formular nach erfolgreicher Aktion aus.
 *
 ...
 *
 * Wenn keine Standorte vorhanden sind, wird eine entsprechende Benachrichtigung angezeigt. Bei erfolgreichem Export wird die Anzahl der exportierten Standorte gemeldet. Im Fehlerfall erscheint eine Fehlermeldung.
 */
