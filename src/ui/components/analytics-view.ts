 ...
 *
 * Erstellt die Benutzeroberfläche mit Auswahlfeldern für Standort, Tresen und Bereich, lädt relevante Daten aus der Datenbank, bindet Event-Listener und zeigt initial leere Diagramme an.
 *
...
/**
 * Befüllt das Standort-Auswahlfeld mit allen verfügbaren Standorten und einer Option für den gesamten Standort.
 *
 * Setzt die Auswahl zurück und ersetzt alle bisherigen Optionen durch die geladenen Standorte.
 */
 ...
 *
 * Setzt die Tresen- und Bereichsauswahl zurück und deaktiviert sie zunächst. Bei Auswahl eines Standorts werden die zugehörigen Tresen angezeigt und auswählbar gemacht. Löst automatisch die Berichtserstellung aus, wenn ein Standort gewählt ist, oder setzt Auswertung und Diagramme zurück, wenn kein Standort ausgewählt wurde.
 */
 ...
 *
 * Wenn ein Standort und ein Zähler ausgewählt sind, werden die zugehörigen Bereiche zur Auswahl angeboten und die Auswahl aktiviert. Andernfalls wird die Bereichsauswahl zurückgesetzt und deaktiviert.
 */
 ...
 *
 * Entfernt vorhandene Diagramme, setzt die Canvas-Elemente neu ein, leert die Zusammenfassung und initialisiert die Diagramme ohne Daten.
 */
 ...
 *
 * Aggregiert Inventurdaten entsprechend der aktuellen Auswahl, berechnet den Produktverbrauch und die Kosten, filtert nicht konsumierte Produkte heraus und aktualisiert die Diagramme sowie die Zusammenfassung im UI. Bei fehlender Auswahl oder fehlenden Daten werden Hinweise angezeigt und die Anzeige zurückgesetzt.
 */
 ...
 *
 * Erstellt ein Balkendiagramm für den Produktverbrauch in Millilitern und, falls Kostenwerte angegeben sind, ein Tortendiagramm für die Produktkosten in Euro. Bereits vorhandene Diagramme werden vor der Neuerstellung entfernt.
 *
