 ...
 *
 * Erstellt die UI-Struktur für Produktliste, Produktformular sowie Schaltflächen zum Hinzufügen neuer Produkte und zum CSV-Export. Bindet die Komponenten an den zentralen Produkt-Store, lädt initial die Produkte und richtet Event-Handler für Benutzeraktionen ein.
 *
 ...
 *
 * Öffnet einen Bestätigungsdialog für das angegebene Produkt. Bei Bestätigung wird das Produkt aus dem Store entfernt, eine Erfolgsmeldung angezeigt und das Produktformular ggf. ausgeblendet. Bei Fehlern erscheint eine Fehlermeldung.
 *
 * @param productId - Die ID des zu löschenden Produkts
 * @param productName - Der Name des Produkts, das gelöscht werden soll (für die Bestätigungsabfrage)
 */
...
/**
 * Blendet das Produktformular aus, wenn der Benutzer die Eingabe abbricht.
 */
...
/**
 * Lädt die Produktliste initial aus dem ProductStore und verbindet das ProductListComponent mit Store-Updates.
 *
 * Bei Fehlern beim Laden der Produkte wird eine Fehlermeldung angezeigt.
 */
