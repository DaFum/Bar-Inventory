 ...
 *
 * Lädt Standorte und Produkte, richtet die Benutzeroberfläche mit Auswahlleiste, Tabellenbereich und Aktionsleiste ein und zeigt eine Aufforderung an, bis Standort, Tresen und Bereich ausgewählt wurden.
 *
...
/**
 * Wechselt die aktuelle Inventurphase und aktualisiert die Anzeige für den ausgewählten Bereich.
 *
 * Die Auswahlleiste und die Inventurtabelle werden für die neue Phase neu gerendert, sofern ein Bereich ausgewählt ist.
 *
...
/**
 * Behandelt die Änderung der Thekenauswahl, setzt den ausgewählten Bereich zurück und aktualisiert die UI entsprechend.
 *
 * Nach Auswahl einer Theke wird die Auswahlleiste neu gerendert und die Inventartabelle sowie die Aktionsleiste geleert, bis ein Bereich ausgewählt wurde.
 */
...
/**
 * Ergänzt das Inventar des aktuell ausgewählten Bereichs um alle geladenen Produkte und sortiert die Inventarpositionen nach Kategorie und Produktname.
 *
 * Für jedes Produkt wird ein Inventareintrag mit Nullwerten hinzugefügt, falls dieser im Bereich noch nicht existiert. Anschließend werden alle Einträge alphabetisch nach Produktkategorie und -name sortiert.
 */
...
/**
             * Aktualisiert das numerische Feld eines Inventaritems im aktuell ausgewählten Bereich basierend auf einer Benutzereingabe.
             *
             * Die Änderung wird nur im Arbeitsspeicher vorgenommen und erst beim expliziten Speichern dauerhaft übernommen.
             */
 ...
 *
 * Zeigt eine Erfolgsmeldung bei erfolgreichem Speichern oder eine Fehlermeldung bei einem Fehler an. Die Inventurdaten werden erst nach dem Speichern übernommen.
 */
