...
/**
 * Behandelt die Änderung der Thekenauswahl, setzt den ausgewählten Bereich zurück und aktualisiert die Benutzeroberfläche entsprechend.
 *
...
/**
 * Reagiert auf die Auswahl eines Bereichs und aktualisiert die Anzeige der Inventartabelle sowie der Aktionsleiste.
 *
 * Nach Auswahl eines Bereichs werden die entsprechende Inventartabelle und die zugehörigen Aktionsschaltflächen angezeigt. Ist kein Bereich ausgewählt, werden diese UI-Elemente geleert.
 */
 ...
 *
 * Für jedes Produkt wird ein Inventareintrag mit Nullwerten hinzugefügt, falls dieser im Bereich noch nicht existiert. Anschließend werden die Inventarpositionen alphabetisch nach Produktkategorie und -name sortiert.
 */
...
/**
     ...
     *
     * Für jedes Produkt im Bereich werden Eingabefelder für Kästen, Flaschen und offene Menge (ml) angezeigt. Das Eingabefeld für Kästen ist deaktiviert, wenn das Produkt keine Kasteninformation besitzt. Nach dem Rendern werden Event-Listener für die Eingabefelder hinzugefügt, um Benutzereingaben zu verarbeiten und die Navigation per Tastatur zu ermöglichen.
     *
...
/**
             * Aktualisiert das entsprechende numerische Feld eines Inventaritems im aktuell ausgewählten Bereich basierend auf einer Benutzereingabe.
             *
