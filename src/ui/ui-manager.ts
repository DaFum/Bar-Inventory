 ...
 *
 * Fügt Event-Listener zu den Navigations- und Theme-Buttons hinzu, um Ansichtswechsel und das Umschalten des Farbschemas zu ermöglichen.
 */
...
/**
 * Wechselt zur angegebenen Ansicht und lädt den passenden Inhalt in den Hauptbereich der Anwendung.
 *
 * @param viewName - Der Name der Zielansicht, die angezeigt werden soll
 */
...
/**
 * Aktualisiert die Navigation, indem die Schaltfläche der aktuellen Ansicht hervorgehoben und die Hervorhebung bei allen anderen entfernt wird.
 */
