 ...
 *
 * Ermittelt die verbrauchte Menge in Standard-Einheiten und Millilitern sowie die zugehörigen Kosten. Erkennt negative Verbrauchswerte oder fehlende Preisinformationen und gibt entsprechende Hinweise im Ergebnis zurück.
 *
...
/**
 * Berechnet den Verbrauch und die Kosten für mehrere Inventarpositionen anhand der zugehörigen Produktdefinitionen.
 *
 ...
 *
 * @returns Ein Array von Verbrauchsdaten für alle Inventarpositionen.
 */
