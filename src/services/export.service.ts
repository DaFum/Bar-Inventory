 ...
 *
 * Wenn keine Daten vorhanden sind, wird entweder eine leere Zeichenkette oder nur die Spaltenüberschriften zurückgegeben.
 *
 * @param data - Die zu exportierenden Objekte als Array
 ...
 * @returns Der generierte CSV-Inhalt als String
 */
...
export class ExportService {
    ...
    public exportAreaInventoryToCsv(
        ...
        const columns = [
            'productId', 'productName', 'category', 'productVolumeMl',
            'startCrates', 'startBottles', 'startOpenVolumeMl',
            'endCrates', 'endBottles', 'endOpenVolumeMl'
        ];
        if (includeConsumption) {
     ...
     */
    public exportLocationToJson(location: Location, allProducts?: Product[]): void {
