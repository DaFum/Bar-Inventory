...
describe('Calculation Service', () => {
  describe('calculateSingleItemConsumption', () => {
    ...
    it('should detect negative consumption', () => {
      ...
      expect(result.notes).toContain('Negative consumption detected (-12000ml). End count is higher than start.');
    });
    ...
    it('should handle product with zero volume', () => {
      ...
      expect(result.notes).toContain('Invalid product volume detected. Using raw volume for consumption units.');
  ...
  describe('Edge Cases and Error Handling', () => {
    ...
    it('should handle extreme negative consumption', () => {
      ...
      expect(result.notes).toContain('Negative consumption detected (-1200000ml). End count is higher than start.');
    });
